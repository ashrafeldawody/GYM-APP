                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td align="center" class="center-text">
                                    <img style="width:190px;border:0px;display: inline!important;" src="https://i.postimg.cc/jdQRr6r4/Email-1-Intro.png" width="190" border="0"       alt="intro">
                                </td>
                            </tr>
                            <tr  >
                                <td height="40" style="font-size:40px;line-height:40px;" >&nbsp;</td>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div  >
                                        <strong>{{$name}}</strong> , {{ __('pleb.mail.Welcome Paragraph') }}
                                    </div>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    <tr  >
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('pleb.mail.icon_one') }}" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    <tr  >
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('pleb.mail.icon_two') }}" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="70" style="width:70px;max-width:70px;">
                                                    <tr  >
                                                        <td align="center">
                                                            <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('pleb.mail.icon_three') }}" border="0"  alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                                                            ...
                                                            @if( config('pleb.mail.instagram_url') != '')
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.facebook_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://i.postimg.cc/Bn0tTQJM/Facebook.png" width="36" border="0"       alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            @if( config('pleb.mail.instagram_url') != '')
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.instagram_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://i.postimg.cc/v841MNPL/Instagram.png" width="36" border="0"       alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            @if( config('pleb.mail.twitter_url') != '')
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.twitter_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://i.postimg.cc/sXNRwK73/Twitter.png" width="36" border="0"       alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            @if( config('pleb.mail.pinterest_url') != '')
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.pinterest_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://i.postimg.cc/5jcWM0sG/Pinterest.png" width="36" border="0"       alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr  >
                                                            <td align="center">
                                                                <a href="{{config('pleb.mail.ios_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;"    width="117" src="https://i.postimg.cc/G2y1gGQY/App-Store.png" border="0"  alt="icon"></a>
                                                            </td>
                                                            <td width="10" style="width: 10px;"></td>
                                                            <td align="center">
                                                                <a href="{{config('pleb.mail.play_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;"    width="117" src="https://i.postimg.cc/c1PvJB2q/Google-play.png" border="0"  alt="icon"></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
